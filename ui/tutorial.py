...
class TutorialManager:
    ...
    def start_tutorial(self, tutorial_name, root, on_complete=None):
        import tkinter.messagebox as mb
        # mb.showinfo("Tutorial Debug", f"start_tutorial called with {tutorial_name}")
    ...
    def show_step(self):
        self._cleanup()
        if not self.current_tutorial or not self.active_root:
            import tkinter.messagebox as mb
            mb.showerror("Tutorial Error", "show_step aborted due to missing tutorial or root")
            return
